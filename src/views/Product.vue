<template>
  <div>
    ...
    <main class="mt-10">
      ...
      <pagination />
        ...
        <div class="flex flex-col flex-1">
            ...
            <div class="flex flex-1 gap-2 md:ml-3">
              ...
              <span
                class="
                  ...
                  font-poppins
                "
                style="font-size: 7px; background-color: #3ab137"
              >
                20%
              </span>
            </div>
          ...
          <div
            ...
            "
          >
            <span class="text-sm font-bold font-lato mb-2 md:mb-0"
              >Screen Size</span
            >
            ...
            <div class="flex flex-col md:flex-row gap-3">
              <span
                class="
                  ...
                  font-lato
                "
                style="border-color: #ffeade; color: #7b7b7b; font-size: 10px"
              >
                14-Inch
              </span>
              <span
                class="
                  ...
                  font-lato
                "
                style="font-size: 10px; background-color: #a1e887"
              >
                24-Inch
              </span>
              <span
      ...
      <div
        class="flex flex-col md:flex-row justify-between mb-20 mx-5 md:mx-p-w"
      >
        <div
          class="
            flex flex-col
        ...
        >
          ...
          <div class="flex flex-col gap-6 mt-12">
            <div
              ...
              :key="item.star"
              class="flex flex-col w-40 gap-2"
            >
