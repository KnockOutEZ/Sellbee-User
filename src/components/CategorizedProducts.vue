<template>
  <div>
            ...
            <div class="flex items-center justify-between mt-7">
                <span class="font-normal font-lato" style=" color: #A3A3A3; font-size: 8px ">
                    Showing 9 of 120 results
                </span>

                <div class="flex gap-1">
                    <span
                        class="flex items-center justify-center h-6 font-bold text-white cursor-pointer bg-bg-primary font-lato"
                        style=" font-size: 8px; border-radius: 6.5px; width: 29.5px "
                    >
                        1
                    </span>
                    <span
                        class="flex items-center justify-center h-6 px-3 font-extrabold cursor-pointer text-bg-primary font-lato"
                        style="
                            font-size: 8px;
                            borderRadius: 6.5px;
                    ...
                    <span
                        class="flex items-center justify-center h-6 px-3 font-bold cursor-pointer text-bg-primary font-lato"
                        style="
                            font-size: 8px;
                            border-radius: 6.5px;
