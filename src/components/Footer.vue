<template>
    ...
    >
        ...
        <div class="flex flex-col flex-1 gap-4 text-white">
            <span class="relative text-lg font-extrabold font-lato w-max">
            ...
            <span class="tracking-wide font-poppins" style=" font-size: 10px; max-width: 550px ">
        ...
        <div class="w-full" style=" max-width: 400px ">
            <div class="relative">
                <input
                    type="text"
                    class="z-10 w-full h-10 bg-white rounded-md outline-none placeholder-footer-input-placeholder"
                    style="
                        font-size: 9px;
                        padding: 12px 15px;
                    "
                ...
                <button
                    type="button"
                    style=" background-color: #565656; height: 30px; font-size: 10px "
                    class="absolute z-10 px-6 font-semibold tracking-wide text-white transform -translate-y-1/2 rounded-md font-lato top-1/2 right-2"
                >
                    SUBSCRIBE
                </button>
        ...
        <div class="relative flex flex-wrap space-y-5 justify-between py-20 px-p-w bg-bg-primary font-lato">
            ...
            <div class="z-10 flex flex-col">
                <img src="/logo-light.svg" alt="logo" style=" max-width: 138px " />

                <span class="mt-2 mb-5 text-white" style=" max-width: 220px; font-size: 10px ">
            ...
            <div class="flex flex-col gap-2">
                ...
                <span class="text-xs font-light text-gray-300">About Us</span>
                <span class="text-xs font-light text-gray-300">Contact Us</span>
                <span class="text-xs font-light text-gray-300">Products</span>
                <span class="text-xs font-light text-gray-300">Login</span>
                <span class="text-xs font-light text-gray-300">Sign Up</span>
            </div>
            ...
            <div class="flex flex-col gap-2">
                ...
                <span class="text-xs font-light text-gray-300">My Account</span>
                <span class="text-xs font-light text-gray-300">Orders</span>
                <span class="text-xs font-light text-gray-300">Tracking List</span>
                <span class="text-xs font-light text-gray-300">Terms</span>
                <span class="text-xs font-light text-gray-300">Privacy Policy</span>
            ...
            <div class="flex flex-wrap flex-col gap-5" style=" max-width: 310px ">
                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex flex-wrap flex-col justify-between">
                        ...
                        <span class="text-xs text-white">01720636876</span>
                    </div>
                    <button
                        type="button"
                        class="px-5 py-2 ml-12 text-xs font-bold tracking-wide uppercase bg-white border rounded-md"
                        style=" border-color: #3D7BD8; color: #3D7BD8 "
                    >
                        live chat
                    </button>
                </div>
                <div class="flex md:space-y-0 space-y-5 flex-wrap justify-between">
                    ...
                    >
                        ...
                        <div class="flex flex-col flex-wrap gap-1">
                            ...
                            <span class="font-black text-white" style=" font-size: 10px ">
                                App Store
                            </span>
                        </div>
                    </button>
            ...
            <div
        class="flex text-white bg-bg-secondary px-p-w"
        style=" padding-top: 7.35px; padding-bottom: 7.35px "
    >
        <span class="flex-1 text-xs">Roney.LIVE - © 2021 All Rights Reserved</span>
